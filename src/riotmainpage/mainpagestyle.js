...
export const ArenaSection = styled(Section)`
    height: 640px;
    background-image: url('/public/mainpageimg/gamemod.png');
    color: white;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
export const ChampionSection = styled(Section)`
    ...
    align-items: center;
    padding: 100px 20px;
    background-image: url('/public/mainpageimg/img2.png');
    background-size: cover;
    background-position: center;
    height: 1000px;
    color: #333;
...
export const MapSections = styled.section`
    padding: 80px 20px;
    text-align: center;
    background-image: url('/public/mainpageimg/gameplayback.png');
    background-size: cover;
    background-position: center;
    color: #fff;
`;
